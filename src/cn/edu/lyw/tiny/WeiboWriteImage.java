...
public class WeiboWriteImage extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_weibowrite_imagedelete = (Button) findViewById(R.id.btn_weibowrite_imagedelete);
		btn_weibowrite_imageok = (Button) findViewById(R.id.btn_weibowrite_imageok);
		...
		Dialog dialog = new AlertDialog.Builder(this).setTitle(R.string.weibosdk_attention)
				...
				.setPositiveButton(R.string.weibosdk_ok, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						iv_weibowrite_image.setImageResource(R.drawable.tinyweibologo);
						if (imagePath != null) {
